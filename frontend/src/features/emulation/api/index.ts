  ...
  history: [
    {
      id: "h1",
      date: "07/04/2026",
      content: "1 đi học muộn",
      points: -10,
      teamId: 1,
      actor: "Đặng Phong Hào",
    },
    {
      id: "h2",
      date: "07/04/2026",
      content: "Bạn A 8 điểm kiểm tra bài cũ",
      points: 5,
      teamId: 1,
      actor: "Đặng Phong Hào",
    },
  ...
  monthlyRanking: [
    {
      ...
      teamId: 1,
      points: 432,
      weeks: { t1: 102, t2: 112, t3: 124, t4: 94 },
    },
    {
      rank: 2,
      teamId: 2,
      points: 421,
      weeks: { t1: 100, t2: 105, t3: 110, t4: 106 },
    },
  ],
};
...
export const emulationAPI = {
  ...
  getCompetition: async (
    ...
    console.log(
      `Fetching competition for class ${classId}, week ${week}, month ${month}`,
    );
    return new Promise((resolve) =>
      setTimeout(() => resolve(mockCompetitionData), 500),
    );
  },
  ...
  removeMemberFromTeam: async (
    ...
    console.log(
      `API: Xóa SV ${studentId} khỏi Tổ ${teamId} của lớp ${classId}`,
    );
  ...
  addPoints: async (
    ...
    console.log(
      `API: Tổ ${teamId} được ghi nhận: "${content}" với số điểm ${points}`,
    );
    // Thay API thật
    return new Promise((resolve) => setTimeout(resolve, 300));
  },
