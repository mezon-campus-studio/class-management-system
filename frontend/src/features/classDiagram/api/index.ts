...
const mockDiagramData: ClassDiagramData = {
  ...
  seats: [
    // Dãy trái
    { id: "s1", name: "Phong Hào", row: 1, column: 1, side: "left", status: "present" },
    { id: "s2", name: "", row: 1, column: 3, side: "left", status: "absent_excused" }, // Ô vàng
    { id: "s3", name: "Trần Việt Tuấn", row: 2, column: 1, side: "left", status: "empty" }, // Ô xám
    { id: "s4", name: "Thiên Bảo", row: 3, column: 1, side: "left", status: "present" },
    { id: "s5", name: "", row: 3, column: 3, side: "left", status: "empty" },
    { id: "s6", name: "Thế Sơn", row: 4, column: 1, side: "left", status: "present" },
    { id: "s7", name: "", row: 4, column: 3, side: "left", status: "absent_unexcused" }, // Ô đỏ
    { id: "s8", name: "Gia Huy", row: 5, column: 1, side: "left", status: "present" },
    ...
    { id: "s12", name: "", row: 2, column: 3, side: "right", status: "absent_unexcused" },
    { id: "s13", name: "", row: 5, column: 2, side: "right", status: "absent_excused" },
    { id: "s14", name: "", row: 5, column: 4, side: "right", status: "absent_excused" },
...
export const classDiagramAPI = {
  getDiagram: async (classId: string): Promise<ClassDiagramData> => {
    ...
    return new Promise((resolve) => setTimeout(() => resolve(mockDiagramData), 500));
  ...
  assignSeat: async (studentId: string, row: number, col: number, side: 'left' | 'right') => {
    console.log(`API: Xếp SV ${studentId} vào Hàng ${row}, Cột ${col}, Dãy ${side}`);
    return new Promise((resolve) => setTimeout(resolve, 300));
  },
